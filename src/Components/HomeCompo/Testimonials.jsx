...
const Testimonials = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <h1 className="text-3xl font-medium title-font text-gray-900 mb-6 text-center">Testimonials</h1>
    <p className="text-xl  text-gray-900 mb-12 text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio vel accusamus, minus vitae magnam dignissimos?</p>
